...
MyScene::MyScene(){
    ...
    for (int i = 0; i < model1->meshes.size(); ++i){
        ...
        model1->materials[i]->uniforms["light.direction"].first = &DI::_imguiData->vslot1;
    }
    ...
    for (int i = 0; i < model2->meshes.size(); ++i){
        ...
        model2->materials[i]->uniforms["dirLight.direction"].first = &DI::_imguiData->vslot1;

        model2->materials[i]->uniforms["pointLights.position"].first = &DI::_imguiData->vslot2;
        ...
        model2->materials[i]->uniforms["spotLight.direction"].first = new glm::vec3(DI::_imguiData->slot0, DI::_imguiData->slot1, DI::_imguiData->slot2);
    ...
    for (int i = 0; i < model4->meshes.size(); ++i){
        ...
        model4->materials[i]->uniforms["dirLight.direction"].first = &DI::_imguiData->vslot1;

        model4->materials[i]->uniforms["pointLights.position"].first = &DI::_imguiData->vslot2;
        ...
        model4->materials[i]->uniforms["spotLight.direction"].first = new glm::vec3(DI::_imguiData->slot0, DI::_imguiData->slot1, DI::_imguiData->slot2);
