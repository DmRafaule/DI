...
void ShaderHandler::processUniforms(Shader& shader, const std::string& src){
   std::unordered_set<std::string> types_complex({"vec","ivec","uvec","bvec","dvec","mat"});
   std::unordered_set<std::string> types_simple({"float","double","uint","int","bool"});
   int start = 0;
   int end = 0;
...
void ShaderHandler::SetUniform(const Shader &shader, const char* name, const float& arg1, const float& arg2){
   glUniform2f(glGetUniformLocation(shader.id,name),arg1,arg2);
}
void ShaderHandler::SetUniform(const Shader &shader, const char* name, const float& arg1, const float& arg2, const float& arg3){
   glUniform3f(glGetUniformLocation(shader.id,name),arg1,arg2,arg3);
}
void ShaderHandler::SetUniform(const Shader &shader, const char* name, const float& arg1, const float& arg2, const float& arg3, const float& arg4){
   glUniform4f(glGetUniformLocation(shader.id,name),arg1,arg2,arg3,arg4);
}

void ShaderHandler::SetUniform(const Shader &shader, const char* name, const int& arg1, const int& arg2){
   glUniform2i(glGetUniformLocation(shader.id,name),arg1,arg2);
}
void ShaderHandler::SetUniform(const Shader &shader, const char* name, const int& arg1, const int& arg2, const int& arg3){
   glUniform3i(glGetUniformLocation(shader.id,name),arg1,arg2,arg3);
}
void ShaderHandler::SetUniform(const Shader &shader, const char* name, const int& arg1, const int& arg2, const int& arg3, const int& arg4){
   glUniform4i(glGetUniformLocation(shader.id,name),arg1,arg2,arg3,arg4);
}
void ShaderHandler::SetUniform(const Shader &shader, const char* name, const unsigned int& arg1, const unsigned int& arg2){
   glUniform2ui(glGetUniformLocation(shader.id,name),arg1,arg2);
}
void ShaderHandler::SetUniform(const Shader &shader, const char* name, const unsigned int& arg1, const unsigned int& arg2, const unsigned int& arg3){
   glUniform3ui(glGetUniformLocation(shader.id,name),arg1,arg2,arg3);
}
void ShaderHandler::SetUniform(const Shader &shader, const char* name, const unsigned int& arg1, const unsigned int& arg2, const unsigned int& arg3, const unsigned int& arg4){
   glUniform4ui(glGetUniformLocation(shader.id,name),arg1,arg2,arg3,arg4);
}
void ShaderHandler::SetUniform(const Shader &shader, const char* name, const double& arg1, const double& arg2){
   glUniform2d(glGetUniformLocation(shader.id,name),arg1,arg2);
}
void ShaderHandler::SetUniform(const Shader &shader, const char* name, const double& arg1, const double& arg2, const double& arg3){
   glUniform3d(glGetUniformLocation(shader.id,name),arg1,arg2,arg3);
}
void ShaderHandler::SetUniform(const Shader &shader, const char* name, const double& arg1, const double& arg2, const double& arg3, const double& arg4){
